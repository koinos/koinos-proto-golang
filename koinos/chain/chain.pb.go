...
type ContractMetadataObject struct {
	...
	AuthorizesUseResources   bool   `protobuf:"varint,4,opt,name=authorizes_use_resources,json=authorizesUseResources,proto3" json:"authorizes_use_resources,omitempty"`
...
func (x *ContractMetadataObject) GetAuthorizesUseResources() bool {
	if x != nil {
		return x.AuthorizesUseResources
	}
	return false
}
...
var file_koinos_chain_chain_proto_rawDesc = []byte{
	...
	0x22, 0xf8, 0x01, 0x0a, 0x18, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x5f, 0x6d, 0x65,
	...
	0x61, 0x63, 0x74, 0x12, 0x38, 0x0a, 0x18, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65,
	0x73, 0x5f, 0x75, 0x73, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x16, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65,
	0x73, 0x55, 0x73, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x3c, 0x0a,
	...
	0x6f, 0x61, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x22, 0x69, 0x0a, 0x0d, 0x67,
...
var file_koinos_chain_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_koinos_chain_chain_proto_goTypes = []interface{}{
	...
	(*GenesisEntry)(nil),           // 8: koinos.chain.genesis_entry
	(*GenesisData)(nil),            // 9: koinos.chain.genesis_data
...
var file_koinos_chain_chain_proto_depIdxs = []int32{
	...
	10, // 1: koinos.chain.head_info.head_topology:type_name -> koinos.block_topology
	...
	8,  // 4: koinos.chain.genesis_data.entries:type_name -> koinos.chain.genesis_entry
