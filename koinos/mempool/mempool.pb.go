...
type PendingTransaction struct {
	...
	SystemDiskStorageUsed      uint64                `protobuf:"varint,5,opt,name=system_disk_storage_used,json=systemDiskStorageUsed,proto3" json:"system_disk_storage_used,omitempty"`
	SystemNetworkBandwidthUsed uint64                `protobuf:"varint,6,opt,name=system_network_bandwidth_used,json=systemNetworkBandwidthUsed,proto3" json:"system_network_bandwidth_used,omitempty"`
	SystemComputeBandwidthUsed uint64                `protobuf:"varint,7,opt,name=system_compute_bandwidth_used,json=systemComputeBandwidthUsed,proto3" json:"system_compute_bandwidth_used,omitempty"`
}
...
func (x *PendingTransaction) GetSystemDiskStorageUsed() uint64 {
	if x != nil {
		return x.SystemDiskStorageUsed
	}
	return 0
}

func (x *PendingTransaction) GetSystemNetworkBandwidthUsed() uint64 {
	if x != nil {
		return x.SystemNetworkBandwidthUsed
	}
	return 0
}

func (x *PendingTransaction) GetSystemComputeBandwidthUsed() uint64 {
	if x != nil {
		return x.SystemComputeBandwidthUsed
	}
	return 0
}
...
type PendingTransactionRecord struct {
	...
	PendingTransaction *PendingTransaction `protobuf:"bytes,1,opt,name=pending_transaction,json=pendingTransaction,proto3" json:"pending_transaction,omitempty"`
...
func (x *PendingTransactionRecord) Reset() {
	*x = PendingTransactionRecord{}
	if protoimpl.UnsafeEnabled {
		mi := &file_koinos_mempool_mempool_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PendingTransactionRecord) Descriptor() ([]byte, []int) {
	return file_koinos_mempool_mempool_proto_rawDescGZIP(), []int{3}
}

func (x *PendingTransactionRecord) GetPendingTransaction() *PendingTransaction {
	if x != nil {
...
var file_koinos_mempool_mempool_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x09, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x52, 0x63, 0x22, 0xc4, 0x03, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a, 0x11, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x73, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x42,
	...
	0x62, 0x61, 0x6e, 0x64, 0x77, 0x69, 0x64, 0x74, 0x68, 0x5f, 0x75, 0x73, 0x65, 0x64, 0x18, 0x03,
	...
	,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x76, 0x32, 0x2f, 0x6b, 0x6f, 0x69, 0x6e, 0x6f, 0x73, 0x2f, 0x6d, 0x65, 0x6d, 0x70, 0x6f, 0x6f,
...
var file_koinos_mempool_mempool_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_koinos_mempool_mempool_proto_goTypes = []interface{}{
	...
	(*PendingTransaction)(nil),       // 2: koinos.mempool.pending_transaction
	(*PendingTransactionRecord)(nil), // 3: koinos.mempool.pending_transaction_record
	(*protocol.Transaction)(nil),     // 4: koinos.protocol.transaction
}
var file_koinos_mempool_mempool_proto_depIdxs = []int32{
	4, // 0: koinos.mempool.pending_transaction.transaction:type_name -> koinos.protocol.transaction
	2, // 1: koinos.mempool.pending_transaction_record.pending_transaction:type_name -> koinos.mempool.pending_transaction
...
func file_koinos_mempool_mempool_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_koinos_mempool_mempool_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
