...
type PendingTransactionFailed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PendingTransactionFailed) Reset() {
	*x = PendingTransactionFailed{}
	if protoimpl.UnsafeEnabled {
...
func (x *PendingTransactionFailed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PendingTransactionFailed) ProtoMessage() {}

func (x *PendingTransactionFailed) ProtoReflect() protoreflect.Message {
	mi := &file_koinos_broadcast_broadcast_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PendingTransactionFailed.ProtoReflect.Descriptor instead.
func (*PendingTransactionFailed) Descriptor() ([]byte, []int) {
	return file_koinos_broadcast_broadcast_proto_rawDescGZIP(), []int{1}
}

func (x *PendingTransactionFailed) GetTransaction() *protocol.Transaction {
	if x != nil {
		return x.Transaction
	}
	return nil
...
var file_koinos_broadcast_broadcast_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x68, 0x74, 0x22, 0x5c, 0x0a, 0x1a, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f,
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x61, 0x69, 0x6c,
	...
	0x6f, 0x6e, 0x22, 0x78, 0x0a, 0x0e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x61, 0x63, 0x63, 0x65,
	0x70, 0x74, 0x65, 0x64, 0x12, 0x2c, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20,
	...
	0x63, 0x6b, 0x12, 0x38, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x18, 0x02, 0x20,
	...
	0x69, 0x70, 0x74, 0x52, 0x07, 0x72, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x22, 0x48, 0x0a, 0x12,
	...
	0x61, 0x64, 0x73, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_koinos_broadcast_broadcast_proto_goTypes = []interface{}{
	...
	(*PendingTransactionFailed)(nil),    // 1: koinos.broadcast.pending_transaction_failed
...
var file_koinos_broadcast_broadcast_proto_depIdxs = []int32{
	...
	5, // 2: koinos.broadcast.pending_transaction_failed.transaction:type_name -> koinos.protocol.transaction
	7, // 3: koinos.broadcast.block_accepted.block:type_name -> koinos.protocol.block
	8, // 4: koinos.broadcast.block_accepted.receipt:type_name -> koinos.protocol.block_receipt
	9, // 5: koinos.broadcast.block_irreversible.topology:type_name -> koinos.block_topology
	9, // 6: koinos.broadcast.fork_heads.last_irreversible_block:type_name -> koinos.block_topology
	9, // 7: koinos.broadcast.fork_heads.heads:type_name -> koinos.block_topology
...
func file_koinos_broadcast_broadcast_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_koinos_broadcast_broadcast_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PendingTransactionFailed); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
