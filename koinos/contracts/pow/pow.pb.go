...
type DifficultyMetadataResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DifficultyMetadataResult) Reset() {
	*x = DifficultyMetadataResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *DifficultyMetadataResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DifficultyMetadataResult) ProtoMessage() {}

func (x *DifficultyMetadataResult) ProtoReflect() protoreflect.Message {
	mi := &file_koinos_contracts_pow_pow_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DifficultyMetadataResult.ProtoReflect.Descriptor instead.
func (*DifficultyMetadataResult) Descriptor() ([]byte, []int) {
	return file_koinos_contracts_pow_pow_proto_rawDescGZIP(), []int{1}
}

func (x *DifficultyMetadataResult) GetValue() *DifficultyMetadata {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_koinos_contracts_pow_pow_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x63, 0x74, 0x73, 0x2f, 0x70, 0x6f, 0x77, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_koinos_contracts_pow_pow_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_koinos_contracts_pow_pow_proto_goTypes = []interface{}{
	...
	(*DifficultyMetadataResult)(nil), // 1: koinos.contracts.pow.difficulty_metadata_result
	(*PowSignatureData)(nil),         // 2: koinos.contracts.pow.pow_signature_data
}
var file_koinos_contracts_pow_pow_proto_depIdxs = []int32{
	0, // 0: koinos.contracts.pow.difficulty_metadata_result.value:type_name -> koinos.contracts.pow.difficulty_metadata
...
func file_koinos_contracts_pow_pow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_koinos_contracts_pow_pow_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DifficultyMetadataResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
